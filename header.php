        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="fas fa-shopping-bag"></i> (0)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#"><i class="fas fa-search"></i> SEARCH</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#"></i><i class="fas fa-download"></i></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container">
            ...
            <div class="mx-auto" id="navbarSupportedContent">
                <ul class="nav justify-content-end">
                    <li class="nav-item">
                        <a class="nav-link submenu" href="#"><small class="small">May Cart:</small> 0 Item(s)</a>
                    </li>
                </ul>
            </div>
        </div>
